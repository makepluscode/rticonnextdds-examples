        ...
        unsigned int sample_count)
{
    ...
    const std::string participant_snapshot = "publisher_participant_snapshot.xml";
    const std::string writer_snapshot = "publisher_datawriter_snapshot.xml";
    ...
    std::cout << "DataWriter snapshot: " << writer_snapshot << std::endl;
    rti::util::discovery::take_snapshot(writer, writer_snapshot);
